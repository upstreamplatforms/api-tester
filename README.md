...
#### Stateless mode
You can just run any tests in stateless mode without saving anything to the server, and just get the results back as JSON or YAML (just set the `accept` header).
